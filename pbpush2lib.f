...
c pbpush2lib.f contains procedures to process particles with magnetic
c              fields:
c PGJPOST2 deposits 3 component current density, quadratic
c          interpolation, STANDARD optimization, and distributed data.
c PGSJPOST2 deposits 3 component current density, quadratic
c           interpolation, LOOKAHEAD optimization, and distributed data.
c PGSJOST2X deposits 3 component current density, quadratic
c           interpolation, VECTOR optimization, and distributed data.
c PGJPOST2L deposits 3 component current density, linear interpolation,
c           STANDARD optimization, and distributed data.
c PGSJPOST2L deposits 3 component current density, linear interpolation,
c            LOOKAHEAD optimization, and distributed data.
c PGSJOST2XL deposits 3 component current density, linear interpolation,
c            VECTOR optimization, and distributed data.
c PGJPOST22 deposits 2 component current density, quadratic
c           interpolation, STANDARD optimization, and distributed data.
c PGSJPOST22 deposits 2 component current density, quadratic
c            interpolation, LOOKAHEAD optimization, and distributed data
c PGSJOST22X deposits 2 component current density, quadratic
c            interpolation, VECTOR optimization, and distributed data.
c PGJPOST22L deposits 2 component current density, linear interpolation,
c            STANDARD optimization, and distributed data.
c PGSJPOST22L deposits 2 component current density, linear
c             interpolation, LOOKAHEAD optimization, and distributed
c             data.
c PGSJOST22XL deposits 2 component current density, linear
c             interpolation, VECTOR optimization, and distributed data.
c PGBPUSH2 push particles with 3 component magnetic field, 2 component
c          electric field, quadratic interpolation, STANDARD
c          optimization, and distributed data.
c PGSBPUSH2 push particles with 3 component magnetic field, 2 component
c           electric field, quadratic interpolation, LOOKAHEAD
c           optimization, and distributed data.
c PGBPUSH2L push particles with 3 component magnetic field, 2 component
c           electric field, linear interpolation, STANDARD optimization,
c           and distributed data.
c PGSBPUSH2L push particles with 3 component magnetic field, 2 component
c            electric field, linear interpolation, LOOKAHEAD
c            optimization, and distributed data.
c PGBPUSH23 push particles with 3 component magnetic field, 3 component
c           electric field, quadratic interpolation, STANDARD
c           optimization, and distributed data.
c PGSBPUSH23 push particles with 3 component magnetic field, 3 component
c            electric field, quadratic interpolation, LOOKAHEAD
c            optimization, and distributed data.
c PGBPUSH23L push particles with 3 component magnetic field, 3 component
c            electric field, linear interpolation, STANDARD
c            optimization, and distributed data.
c PGSBPUSH23L push particles with 3 component magnetic field,
c             3 component electric field, linear interpolation,
c             LOOKAHEAD optimization, and distributed data.
c PGBPUSH22 push particles with 1 component magnetic field, 2 component
c           electric field, quadratic interpolation, STANDARD
c           optimization, and distributed data.
c PGSBPUSH22 push particles with 1 component magnetic field, 2 component
c            electric field, quadratic interpolation, LOOKAHEAD
c            optimization, and distributed data.
c PGBPUSH22L push particles with 1 component magnetic field, 2 component
c            electric field, linear interpolation, STANDARD
c            optimization, and distributed data.
c PGSBPUSH22L push particles with 1 component magnetic field,
c             2 component electric field, linear interpolation,
c             LOOKAHEAD optimization, and distributed data.
c PRETARD2 retard particle position a half time-step for 2-1/2d code,
c          with distributed data.
c written by viktor k. decyk, ucla
c copyright 1999, regents of the university of california
c update: august 28, 2009
c-----------------------------------------------------------------------
